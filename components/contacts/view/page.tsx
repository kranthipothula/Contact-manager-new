...
const View = () => {
  ...
  <main className="flex min-h -screen flex-col items-center justify-between p-24">
      <div className='w-90 h-90 mx-auto p-5'>
        <h2 className='text-center mb-4 text-green-800 font-bold'>View User</h2>
        <form  className='bg-white rounded p-4 w-120 shadow-md'>
         ...
         <Link href={'/.'} className="text-green-700 underline">back</Link>
        </form>
      </div>
  </main>
  </div>
